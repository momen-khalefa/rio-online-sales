...
background-size: cover;">
    ...
    <div id="wrapper">
        <div id="content">
            <!-- Start main_haeder -->
            <header class="main_haeder header-sticky bg-red">
                <div class="em_menu_sidebar">
                    <button type="button" class="btn btn_menuSidebar item-show" data-toggle="modal"
                        ...
                        <i class="tio-menu_hamburger">momen</i>
                    </button>
                </div>
                <div class="em_brand">
                    <a href="index.html" >
                        <h5 style="color: red;">Rio Cafe</h5>
                    </a>
                </div>
            ...
            <!-- Start  -->
            <section class="banner_sliderFull margin-b-20">
                <!-- Swiper -->
            ...
            <section class="em_swiper_products margin-b-20">
                <div class="em_title_swiper margin-b-20">
                
                    <div class="item_link">
                        <a href="cold_page.php">مشاهدة المزيد</a>
                    </div>
                    <div class="txt" style="text-align: right;">
                        <h2>مشروبات باردة</h2>
                        <p>المشروبات الباردة والمميزة</p>
                    </div>
                </div>
                ...
                for($i=0;$i<count($allRecords);$i++){
                  ...
                  print '          <div class="em_head">';
                  print '           <a href="product.php?c_id=1&p_id='.$allRecords[$i]['id'].'" class="image_product">';
                  print '                  <img src="assets/img/'.$allRecords[$i]['photo'].'" alt="">';
                  print '              </a>';
                  print '          </div>';
                  print '          <div class="title_product">';
                  print '              <h3>'.$allRecords[$i]['name'].'</h3>';
                  print '              <div class="bottom_info">';
                  print '                  <p class="item_price">'.$price.'₪ </p>';
                  print '                  <button type="button" class="btn btn_addCart item-active" name="hot" onclick="SubmitFormData('.$allRecords[$i]['id'].',1,'.$id.');" id="hot" value="'.$allRecords[$i]['id'].'">';
                  print '                     <svg width="24" height="24" viewBox="0 0 24 24" fill="none"';
                  print '                          xmlns="http://www.w3.org/2000/svg">';
                  print '                         <path opacity="0.4" fill-rule="evenodd" clip-rule="evenodd"';
                  print '                              d="M12.75 8.32727C12.75 7.91306 12.4142 7.57727 12 7.57727C11.5858 7.57727 11.25 7.91306 11.25 8.32727V11.2405H8.33333C7.91911 11.2405 7.58333 11.5763 7.58333 11.9905C7.58333 12.4047 7.91911 12.7405 8.33333 12.7405H11.25V15.6536C11.25 16.0678 11.5858 16.4036 12 16.4036C12.4142 16.4036 12.75 16.0678 12.75 15.6536V12.7405H15.6667C16.0809 12.7405 16.4167 12.4047 16.4167 11.9905C16.4167 11.5763 16.0809 11.2405 15.6667 11.2405H12.75V8.32727Z" 
                                                fill="#200E32" />
            ...
            <section class="em_swiper_products margin-b-20">
                <div class="em_title_swiper margin-b-20">
                    <div class="item_link">
                        <a href="hot_page.php">مشاهدة المزيد</a>
                    </div>
                    <div class="txt" style="text-align: right;">
                        <h2>مشروبات ساخنة</h2>
                        <p>المشروبات الساخنة والمميزة</p>
                    </div>
                </div>
                <div class="em_body_products">
                    <div class="owl-carousel owl-theme em-owlRight">
                ...
                for($i=0;$i<count($allRecords);$i++){
                  ...
                  print '     <div class="item em_item_product">';
                  print '          <div class="em_head">';
                  print '           <a href="product.php?c_id=0&p_id='.$allRecords[$i]['id'].'" class="image_product">';
                  print '                  <img src="assets/img/'.$allRecords[$i]['photo'].'" alt="">';
                  print '              </a>';
                  print '          </div>';
                  print '          <div class="title_product" >';
                  ...
                  print '              <div class="bottom_info">';
                  print '                  <p class="item_price">'.$price.'₪ </p>';
                  print '                  <button type="button" class="btn btn_addCart item-active" onclick="SubmitFormData('.$allRecords[$i]['id'].',0,'.$id.');" name="cold"

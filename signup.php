        ...
        <div id="content">
            ...
            <section class="em__signTypeOne">
                ...
                <div class="em__body" style="text-align: right;">
                    ...
                    <button  class="btn bg-primary color-white justify-content-center" name="submit" type="submit">التسجيل الأن</button>
                    <a href="signin.php" class="btn hover:color-secondary justify-content-center">لديك حساب ؟ قم بتسجيل الدخول </a>
                    </div>
                    </form>

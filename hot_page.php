        ...
        <div id="content">
            ...
            <section class="padding-l-20 padding-t-10" style="text-align: right;">
                <ul class="nav navListProducts" >
                    <li class="nav-item">
                        <a class="nav-link active size-20" href="hot_page.php">مشروبات ساخنة</a>
                    </li>
                    <li class="nav-item">
            ...
            <section class="em_masonry__layout">
                ...
                for($i=0;$i<count($allRecords)/2;$i++){
                    ...
                    print '<div class="item em_item_product">
                        <div class="em_head">
                            <a href="product.php?c_id=0&p_id='.$allRecords[$i]['id'].'" class="image_product">
                        ...
                        <div class="title_product">
                            ...
                            <div class="bottom_info">
                                ...
                                <button type="button" class="btn btn_addCart item-active" onclick="SubmitFormData('.$allRecords[$i]['id'].',0,'.$_COOKIE["user_id"].');">
